...
async def send_start(client: Client, message: Message):
    ...
    buttons = [[
        InlineKeyboardButton("❣️ Developer", url = "@coursehizack")
    ],[
        InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='@coursehizack'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='@coursehizack')
    ]]
